...
export default function BottomTabBar() {
  ...
  const hiddenRoutes = ['/onboarding', '/missed', '/ai-summary', '/emergency'];
  if (hiddenRoutes.some((r) => pathname.startsWith(r))) return null;

  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 safe-area-bottom z-40">
